...
/*   Updated: 2025/01/30 12:17:05 by mel-adna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	animate_ghost(void *param)
{
	...
	current_frame = game->ghost_frames[game->current_frame];
	mlx_put_image_to_window(game->mlx, game->win, current_frame,
		game->gost_x * game->tile_size, game->gost_y * game->tile_size);
	return (1);
}
